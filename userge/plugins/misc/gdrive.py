...
from pathlib import _pack_helper
...
#####################################################################
@userge.on_cmd("gzip", about={
    'header': "Zip folders/files from GDrive",
    'usage': "{tr}gzip [folder_id | file/folder link]"}, check_downpath=True)
async def gzip_(message: Message):
    """ zip from gdrive """
